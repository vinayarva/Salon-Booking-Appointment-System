...
date.addEventListener("change", (event) => {
  ...
  axios
    .get("http://16.170.244.158/api/admin/getappointment", {
      params: { date: date },
      headers: {
    ...
    tr.innerHTML = `
                ...
                <td>
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-outline-success completed_btn" id=${
                          element.ID
                        } value = "completed">Completed</button>
                          <button type="button" class="btn btn-outline-danger cancel_btn" id=${
                            element.ID
                          } value = "cancelled">Cancel</button>
                    </div>
                </td>
            `;
